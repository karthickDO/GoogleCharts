export const ChartInputData = {
    ...
    AreaChartData: [
        ...
        [new Date(2315, 2, 15), 1170, 460],
        [new Date(2316, 2, 15), 660, 1120],
    ...
    BarChartMonthData: [
        ...
        [new Date(2019, 7, 15), 1030, 540, 200],
    ...
    BarChartDateData: [
        ['Date', 'Sales', 'Expenses', 'Profit'],
        [new Date(2019, 2, 15), 1000, 400, 200],
        [new Date(2019, 2, 16), 1170, 460, 200],
        [new Date(2019, 2, 17), 660, 1120, 200],
        [new Date(2019, 2, 19), 1030, 540, 200]
    ],

    BarChartWeekData: [
        ['Date', 'Sales', 'Expenses', 'Profit'],
        [new Date(2019, 2, 1), 1000, 400, 200],
        [new Date(2019, 2, 2), 1170, 460, 200],
        [new Date(2019, 2, 3), 660, 1120, 200],
